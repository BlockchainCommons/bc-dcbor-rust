...
#[test]
fn encode_unsigned() {
    test_cbor_codable(0u8,        "UInt(0)", "0", "00");
    test_cbor_codable(0u16,       "UInt(0)", "0", "00");
    test_cbor_codable(0u32,       "UInt(0)", "0", "00");
    test_cbor_codable(0u64,       "UInt(0)", "0", "00");
    test_cbor_codable(0 as usize, "UInt(0)", "0", "00");

    test_cbor_codable(1u8,        "UInt(1)", "1", "01");
    test_cbor_codable(1u16,       "UInt(1)", "1", "01");
    test_cbor_codable(1u32,       "UInt(1)", "1", "01");
    test_cbor_codable(1u64,       "UInt(1)", "1", "01");
    test_cbor_codable(1 as usize, "UInt(1)", "1", "01");

    test_cbor_codable(23u8,        "UInt(23)", "23", "17");
    test_cbor_codable(23u16,       "UInt(23)", "23", "17");
    test_cbor_codable(23u32,       "UInt(23)", "23", "17");
    test_cbor_codable(23u64,       "UInt(23)", "23", "17");
    test_cbor_codable(23 as usize, "UInt(23)", "23", "17");

    test_cbor_codable(24u8,        "UInt(24)", "24", "1818");
    test_cbor_codable(24u16,       "UInt(24)", "24", "1818");
    test_cbor_codable(24u32,       "UInt(24)", "24", "1818");
    test_cbor_codable(24u64,       "UInt(24)", "24", "1818");
    test_cbor_codable(24 as usize, "UInt(24)", "24", "1818");

    test_cbor_codable(u8::MAX,          "UInt(255)", "255", "18ff");
    test_cbor_codable(u8::MAX as u16,   "UInt(255)", "255", "18ff");
    test_cbor_codable(u8::MAX as u32,   "UInt(255)", "255", "18ff");
    test_cbor_codable(u8::MAX as u64,   "UInt(255)", "255", "18ff");
    test_cbor_codable(u8::MAX as usize, "UInt(255)", "255", "18ff");

    test_cbor_codable(u16::MAX,          "UInt(65535)", "65535", "19ffff");
    test_cbor_codable(u16::MAX as u32,   "UInt(65535)", "65535", "19ffff");
    test_cbor_codable(u16::MAX as u64,   "UInt(65535)", "65535", "19ffff");
    test_cbor_codable(u16::MAX as usize, "UInt(65535)", "65535", "19ffff");

    test_cbor_codable(65536u32,          "UInt(65536)", "65536", "1a00010000");
    test_cbor_codable(65536u64,          "UInt(65536)", "65536", "1a00010000");
    test_cbor_codable(65536u64 as usize, "UInt(65536)", "65536", "1a00010000");

    test_cbor_codable(u32::MAX,          "UInt(4294967295)", "4294967295", "1affffffff");
    test_cbor_codable(u32::MAX as u64,   "UInt(4294967295)", "4294967295", "1affffffff");
    test_cbor_codable(u32::MAX as usize, "UInt(4294967295)", "4294967295", "1affffffff");

    test_cbor_codable(4294967296u64, "UInt(4294967296)", "4294967296", "1b0000000100000000");

    test_cbor_codable(u64::MAX,          "UInt(18446744073709551615)", "18446744073709551615", "1bffffffffffffffff");
    test_cbor_codable(u64::MAX as usize, "UInt(18446744073709551615)", "18446744073709551615", "1bffffffffffffffff");
}

#[test]
fn encode_signed() {
    test_cbor_codable(-1i8,  "NInt(-1)", "-1", "20");
    test_cbor_codable(-1i16, "NInt(-1)", "-1", "20");
    test_cbor_codable(-1i32, "NInt(-1)", "-1", "20");
    test_cbor_codable(-1i64, "NInt(-1)", "-1", "20");

    test_cbor_codable(-2i8,  "NInt(-2)", "-2", "21");
    test_cbor_codable(-2i16, "NInt(-2)", "-2", "21");
    test_cbor_codable(-2i32, "NInt(-2)", "-2", "21");
    test_cbor_codable(-2i64, "NInt(-2)", "-2", "21");

    test_cbor_codable(-127i8,  "NInt(-127)", "-127", "387e");
    test_cbor_codable(-127i16, "NInt(-127)", "-127", "387e");
    test_cbor_codable(-127i32, "NInt(-127)", "-127", "387e");
    test_cbor_codable(-127i64, "NInt(-127)", "-127", "387e");

    test_cbor_codable(i8::MIN,        "NInt(-128)", "-128", "387f");
    test_cbor_codable(i8::MIN as i16, "NInt(-128)", "-128", "387f");
    test_cbor_codable(i8::MIN as i32, "NInt(-128)", "-128", "387f");
    test_cbor_codable(i8::MIN as i64, "NInt(-128)", "-128", "387f");

    test_cbor_codable(i8::MAX,        "UInt(127)", "127", "187f");
    test_cbor_codable(i8::MAX as i16, "UInt(127)", "127", "187f");
    test_cbor_codable(i8::MAX as i32, "UInt(127)", "127", "187f");
    test_cbor_codable(i8::MAX as i64, "UInt(127)", "127", "187f");

    test_cbor_codable(i16::MIN,        "NInt(-32768)", "-32768", "397fff");
    test_cbor_codable(i16::MIN as i32, "NInt(-32768)", "-32768", "397fff");
    test_cbor_codable(i16::MIN as i64, "NInt(-32768)", "-32768", "397fff");

    test_cbor_codable(i16::MAX,        "UInt(32767)", "32767", "197fff");
    test_cbor_codable(i16::MAX as i32, "UInt(32767)", "32767", "197fff");
    test_cbor_codable(i16::MAX as i64, "UInt(32767)", "32767", "197fff");

    test_cbor_codable(i32::MIN,        "NInt(-2147483648)", "-2147483648", "3a7fffffff");
    test_cbor_codable(i32::MIN as i64, "NInt(-2147483648)", "-2147483648", "3a7fffffff");

    test_cbor_codable(i32::MAX,        "UInt(2147483647)", "2147483647", "1a7fffffff");
    test_cbor_codable(i32::MAX as i64, "UInt(2147483647)", "2147483647", "1a7fffffff");

    test_cbor_codable(i64::MIN, "NInt(-9223372036854775808)", "-9223372036854775808", "3b7fffffffffffffff");

    test_cbor_codable(i64::MAX, "UInt(9223372036854775807)", "9223372036854775807", "1b7fffffffffffffff");
}
...
#[test]
fn encode_string() {
    test_cbor_codable("Hello".to_string(), r#"String("Hello")"#, r#""Hello""#, "6548656c6c6f");
...
fn encode_heterogenous_array() {
    ...
    let expected_debug = r#"Array([UInt(1), String("Hello"), Array([UInt(1), UInt(2), UInt(3)])])"#;
