...
use super::{cbor::{CBOR, CBOREncodable, Bytes, Value, Tagged}, varint::MajorType, map::CBORMap};
...
#[cfg(test)]
mod test {
    use crate::{cbor::{cbor::{CBOREncodable, Bytes, Value, Tagged}, map::CBORMap, decode::Error}, util::hex::hex_to_bytes};
