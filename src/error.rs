...
/// Provides automatic conversion from UTF-8 errors to `CBORError`.
///
/// This implementation allows functions that can produce UTF-8 errors to simply use
/// the `?` operator to convert those errors into the appropriate `CBORError` variant.
